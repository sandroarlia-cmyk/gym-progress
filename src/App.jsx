...
function ExerciseEditor({ item, ex, last, secondLast, addSet, updateSet, removeSet, removeExercise, hideMuscleBadge, workouts, onOpenExercise }) {
  ...
  return (
    <div className="exercise-block exercise-block-dark">
      ...
      {last && (
        <div className="comp-table-full-row">
                ...
                return (
                  <div key={key} className="log-date-card">
                    <div className="log-date-card-head" onClick={() => toggleExpanded(key)}>
                      ...
                      {sortBy === "peso" ? (
                        <>
                          <div className="log-kgmax-green-box">{kgMax} kg</div>
                          <div className="log-kgmax-acid-box">{ripAlKgMax} Rip</div>
                        </>
                      ) : (
                        <>
...
function ProgressiTab({ workouts, exercises, bodyLogs }) {
  ...
  const [pinnedForzaAnno, setPinnedForzaAnno] = useState(null);
  ...
  return (
    <div className="gt-root">
      <style>{`
        ...
        .settimana-popup-mini-box{ flex-shrink:0; width:80px; box-sizing:border-box; white-space:nowrap; text-align:center; padding:9px 8px; border-radius:6px; font-size:15px; font-weight:700; min-height:38px; display:flex; align-items:center; justify-content:center; }
        .settimana-popup-mini-note{ width:auto; min-width:130px; justify-content:flex-start; text-align:left; }
        ...
        .pinned-info-box{
          display:flex; align-items:center; gap:10px; flex-wrap:wrap; margin-top:10px; padding:10px 14px;
          background:var(--surface-2); border:2px solid var(--accent); border-radius:8px; cursor:pointer;
        }
        ...
        .log-kgmax-green-box{ width:100px; flex-shrink:0; background:#1f6b3a; color:#ffffff; font-weight:700; font-size:22px; border-radius:6px; padding:14px 10px; display:flex; align-items:center; justify-content:center; white-space:nowrap; }
        .log-kgmax-acid-box{ width:100px; flex-shrink:0; background:#aef000; color:#000000; font-weight:700; font-size:22px; border-radius:6px; padding:14px 10px; display:flex; align-items:center; justify-content:center; white-space:nowrap; }
        ...
        .log-kg-value-box{ width:140px; flex-shrink:0; background:var(--accent-dim); color:#000000; font-size:22px; font-weight:700; border-radius:6px; padding:7px 24px 7px 10px; display:flex; align-items:center; justify-content:flex-end; text-align:right; }
        ...
        @media (max-width: 640px) {
          ...
          .history-card-dark .plain-set-row{ grid-template-columns:20px 68px 38px 38px 1fr; }
          ...
          .log-kgmax-green-box{ width:70px; font-size:16px; padding:9px 4px; }
